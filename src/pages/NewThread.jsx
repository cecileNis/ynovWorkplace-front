...
const NewThread = () => {
    ...
    return (
        ...
        >
            ...
            >
                <TextField data-testid="title-input" sx={{mb: 2}} inputRef={title} label="Titre du fil"/>
                <TextField data-testid="content-input" sx={{mb: 2}} inputRef={content} label="Contenu du groupe"
                           multiline rows={4}/>
